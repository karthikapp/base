  	...
  	this.opportunities_SBL.forEach( 
              i => {
                ...
                this.opportunities_SBLV.push({prmkey: prmkey, prmkeyl1: prmkeyl1, prmkeyl2: prmkeyl2, prmkeyl3: prmkeyl3,
                 ...
                 company_id: i.compnay_id, companyname: i.companyname, product: i.product, productname: i.productname,
              ...
              this.dataqSB.forEach( i => {
                ...
                this.pieSBQRevenue.push({id: this.p, parent: 0 , name: this.name, value:this.valuePercent});
